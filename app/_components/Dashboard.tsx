              ...
              <div className="dash-grid">
                ...
                <div>
                  ...
                  {Object.keys(catBudgets).length > 0 && (
                    <div style={card({ padding: '20px 24px' })}>
                      <p style={{ fontSize: '14px', fontWeight: 700, color: '#0f172a', marginBottom: '4px' }}>Budget vs Actual Spending</p>
                      <p style={{ fontSize: '13px', color: '#64748b', marginBottom: '16px', lineHeight: 1.5 }}>
                        How much of each budget you've used this month
                      </p>
                          ...
                          <div key={cat} style={{ marginBottom: '14px' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '5px' }}>
                              ...
                              <span style={{ fontSize: '12px', color: '#64748b' }}>
                                ...
                                {over && (
                                  <span style={{ marginLeft: '6px', fontSize: '11px', background: '#fee2e2', color: '#dc2626', padding: '1px 7px', borderRadius: '20px', fontWeight: 700 }}>
                            ...
                            <div style={{ height: '8px', background: '#f1f5f9', borderRadius: '4px', overflow: 'hidden' }}>
                              <div style={{ height: '100%', width: `${pct}%`, background: barColor, borderRadius: '4px', transition: 'width 0.8s ease' }} />
                            </div>
